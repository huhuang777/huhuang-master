      ...
      >
        ...
        <div class="tools" v-if="stream.local">
          ...
          >
            <i
              class="iconfont"
              :class="[localStream.disabledCarema ? 'icon-carema-disabled' : 'icon-carema']"
            ></i>
          </button>
          <button
            class="audio"
          ...
          >
            <i
              class="iconfont"
              :class="[localStream.disabledMic ? 'icon-mic-disabled' : 'icon-mic']"
            ></i>
          </button>
          <button
            class="beauty"
        ...
        <div class="tools" v-else>
          <button class="video" disabled :class="{ active: !stream.disabledCarema }">
            <i
              class="iconfont"
              :class="[stream.disabledCarema ? 'icon-carema-disabled' : 'icon-carema']"
            ></i>
          </button>
  ...
  mounted() {
    ...
    const webrtc = (this.webrtc = new SimpleWebRTC({
      ...
      peerConnectionConfig: {
        ...
        iceServers: [
          {
            urls: ['stun:47.96.19.254:3478', 'turn:47.96.19.254:3478'],
            username: 'surmon',
            credential: 'surmon'
          }
        ]
...
#global-webrtc {
  ...
  > .webrtc-box {
    ...
    > .stream-box {
      ...
      border: 0.666rem solid $module-bg-opacity-5;
      overflow-y: hidden;
