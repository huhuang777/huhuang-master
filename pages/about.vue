            ...
            <div class="about-me">
              <div class="desc">
                ...
                <p class="item">
                  ...
                  <span class="accounts">
                    <span>
                      <a
                        href="https://github.com/huhuang777"
                        target="_blank"
                        class="github"
                      ...
                      <a
                        href="mailto:huhuang777@foxmail.com"
                        target="_blank"
                        class="mail"
                        rel="external nofollow noopenter"
                      >
                      ...
                      <a
                        href="https://juejin.im/user/5b4d99d8e51d4518ef2cd3fe"
                        target="_blank"
                        class="juejin"
                        rel="external nofollow noopenter"
                      >
                      ...
                      <a
                        href="https://www.zhihu.com/people/hu-huang-71-42/activities"
                        target="_blank"
                        class="zhihu"
                        rel="external nofollow noopenter"
                      >
                      ...
                      <a
                        href="https://space.bilibili.com/39149131/#/video"
                        target="_blank"
                        class="bilibili"
                        rel="external nofollow noopenter"
                      >
                    ...
                    <span v-if="!mobileLayout">
                      <a
                        href="https://www.quora.com/profile/Troye-Hu"
                        target="_blank"
                        class="quora"
                        rel="external nofollow noopenter"
                      >
                      ...
                      <a
                        href="https://twitter.com/huhuang0220"
                        target="_blank"
                        class="twitter"
                        rel="external nofollow noopenter"
                      >
                      ...
                      <a
                        href="https://www.facebook.com/troye.pingkman"
                        target="_blank"
                        class="facebook"
                        rel="external nofollow noopenter"
                      >
                      ...
                      <a
                        href="https://www.instagram.com/troyehu/"
                        target="_blank"
                        class="instagram"
                        rel="external nofollow noopenter"
                      >
              ...
              <div class="gravatar">
                <div class="background be-2">
                  <img
                    :src="cdnUrl+'/images/about-background-be-2.jpg'"
                    alt="background"
                    class="image"
                  />
                </div>
                <div class="background be-1">
                  <img
                    :src="cdnUrl+'/images/about-background-be-1.jpg'"
                    alt="background"
                    class="image"
                  />
                </div>
                <div class="background star-1">
                  <img
                    :src="cdnUrl+'/images/about-background-star-1.png'"
                    alt="background-star"
                    class="image"
                  />
                </div>
                <div class="background star-2">
                  <img
                    :src="cdnUrl+'/images/about-background-star-2.png'"
                    alt="background-star"
                    class="image"
                  />
                </div>
                ...
                <div class="desc">
                  <h2 class="name">
                    <strong>TroyeHu</strong>
                  </h2>
                  <p class="skill">JS Stack Developer.</p>
                </div>
                <a class="followme" href @click.stop.prevent v-if="!mobileLayout">{{'Friend me' }}</a>
